          ...
          {certifications.map((cert, index) => {
            ...
            return (
              <motion.div 
                ...
                className="bg-background rounded-2xl p-6 border border-white/5 hover:border-success/30 transition-all group hover:-translate-y-1"
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="w-14 h-14 bg-success/10 rounded-xl flex items-center justify-center text-success group-hover:scale-110 transition-transform">
                    <Award size={28} />
                  </div>
                ...
                <p className="text-sm text-gray-400 mb-6 flex items-center gap-2">
                  <Icon size={14} className="text-techblue" />
                  {cert.authority}
                </p>
